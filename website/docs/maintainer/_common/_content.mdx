...
**@xpack-dev-tools/texinfo** is an xpm package that packages platform-specific archives, built with the [xPack Build Box (XBB)](https://xpack.github.io/xpack-build-box/).
...
```sh
rm -rf ~/Work/xpack-dev-tools/texinfo-xpack.git/package-lock.json
```
...
npm --prefix ~/Work/xpack-dev-tools/texinfo-xpack.git/build-assets install
xpm install -C ~/Work/xpack-dev-tools/texinfo-xpack.git/build-assets
...
(such as **7.0.3-1.1**) with the following expression:
...
xpm run trigger-workflow-test-docker-linux-arm64 -C ~/Work/xpack-dev-tools/texinfo-xpack.git/build-assets
```
...
tagged such as **v7.0.3-1** (mind the dash in the middle!) and
named such as **xPack GNU texinfo v7.0.3-1** (mind the dash),
...
- Navigate to the [GitHub Releases](https://github.com/xpack-dev-tools/texinfo-xpack/releases) page
...
npm --prefix ~/Work/xpack-dev-tools/texinfo-xpack.git/build-assets install && \
xpm install -C ~/Work/xpack-dev-tools/texinfo-xpack.git/build-assets && \
xpm run test-release -C ~/Work/xpack-dev-tools/texinfo-xpack.git/build-assets
```
