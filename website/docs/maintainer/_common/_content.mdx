...
```sh
npm run generate-top-commons -C ~/Work/xpack-dev-tools/texinfo-xpack.git
```
...
- open https://xpack-dev-tools.github.io/texinfo-xpack/docs/maintainer/#publish-the-website in a separate window
...
[![NPM Version](https://img.shields.io/npm/v/%40xpack-dev-tools%2Ftexinfo?color=green)](https://www.npmjs.com/package/@xpack-dev-tools/texinfo/)
[![NPM Downloads](https://img.shields.io/npm/dm/%40xpack-dev-tools%2Ftexinfo)](https://www.npmjs.com/package/@xpack-dev-tools/texinfo/)
  - all releases [![NPM Downloads](https://img.shields.io/npm/dt/%40xpack-dev-tools%2Ftexinfo)](https://www.npmjs.com/package/@xpack-dev-tools/texinfo/)
