...
**@xpack-dev-tools/texinfo** is an xpm package that packs platform specific archives, built with the [xPack Build Box (XBB)](https://xpack.github.io/xpack-build-box/).
...
```sh
rm -rf ~/Work/xpack-dev-tools/texinfo-xpack.git/build-assets/package-lock.json
