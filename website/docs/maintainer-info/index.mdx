...
title: Information for xPack GNU texinfo maintainers
...
```sh
bash ~/Work/xpack-dev-tools/texinfo-xpack.git/build-assets/xpacks/@xpack-dev-tools/xbb-helper/github-actions/trigger-travis-macos.sh
```
...
named like **xPack GNU texinfo v{ customField('upstreamVersion') }-{ customField('xpackSubversion') }** (mind the dash),
...
- <code>npm dist-tag ls @xpack-dev-tools/texinfo</code>
- <code>npm dist-tag add @xpack-dev-tools/texinfo@{ customField('upstreamVersion') }-{ customField('xpackSubversion') }.{ customField('npmSubversion') } latest</code>
- <code>npm dist-tag ls @xpack-dev-tools/texinfo</code>

In case the previous version is not functional and needs to be unpublished:

- <code>npm unpublish @xpack-dev-tools/texinfo@{ customField('upstreamVersion') }-{ customField('xpackSubversion') }.{ customField('npmSubversion') }</code>
...
- the result is in https://xpack-dev-tools.github.io/texinfo-xpack/blog/
...
- paste the release name like _**xPack GNU texinfo v{ customField('upstreamVersion') }-{ customField('xpackSubversion') } released**_
