...
title: Getting Started with xPack GNU texinfo
...
![GitHub Repo stars](https://img.shields.io/github/stars/xpack-dev-tools/texinfo-xpack)

## Overview

**xPack GNU texinfo** is a standalone
cross-platform (GNU/Linux, macOS)binary distribution of GNU texinfo,
...
[release assets](https://github.com/xpack-dev-tools/texinfo-xpack/releases).

In addition to the binary archives and the package metadata,
this project also includes the
[build scripts](https://github.com/xpack-dev-tools/texinfo-xpack/tree/xpack/build-assets/scripts).
...
The details of installing the **xPack GNU texinfo** on various platforms are
presented in the
...
[GitHub Discussions](https://github.com/xpack-dev-tools/texinfo-xpack/discussions/).
...
[`CHANGELOG.md`](https://github.com/xpack-dev-tools/texinfo-xpack/blob/xpack/CHANGELOG.md) file.
...
[`texinfo-xpack.git/build-assets/scripts`](https://github.com/xpack-dev-tools/texinfo-xpack/tree/xpack/build-assets/scripts/)
...
- **Star** the project on [GitHub](https://github.com/xpack-dev-tools/texinfo-xpack/): It helps others discover our work.
