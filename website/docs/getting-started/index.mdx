...
**xPack GNU texinfo** is a standalone cross-platform (Windows, macOS, GNU/Linux)
binary distribution of GNU texinfo,
intended for reproducible builds.

<Overview/>

**xPack GNU texinfo** is an open source project hosted on GitHub as
...
[build scripts](https://github.com/xpack-dev-tools/texinfo-xpack/tree/xpack/scripts).
...
[`texinfo-xpack.git/scripts`](https://github.com/xpack-dev-tools/texinfo-xpack/tree/xpack/scripts/)
