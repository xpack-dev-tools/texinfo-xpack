...
# How to get help for the xPack GNU texinfo
...
- Check the [GitHub Discussions](https://github.com/xpack-dev-tools/texinfo-xpack/discussions) for
similar topics
- Check the [GitHub Issues](https://github.com/xpack-dev-tools/texinfo-xpack/issues)
tracker and the
...
others, please 
use the [GitHub Discussions](https://github.com/xpack-dev-tools/texinfo-xpack/discussions)
pages.
