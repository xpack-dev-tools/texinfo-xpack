...
title: How to get help for texinfo
...
# How to get help for xPack GNU texinfo
...
distribution, not to the upstream GNU texinfo itself
(if you have doubts, use the GitHub Discussions),
or if you have a pertinent suggestion how to enhance the **xPack GNU texinfo**
