...
`% ~/Library/xPacks/${props.shortName}/xpack-${props.shortName}-7.0.3-1/bin/${props.programName} --version
...
<CodeBlock language="console"> {
`$ ~/.local/xPacks/${props.shortName}/xpack-${props.shortName}-7.0.3-1/bin/${props.programName} --version
${props.branding}7.0.3
`} </CodeBlock>
