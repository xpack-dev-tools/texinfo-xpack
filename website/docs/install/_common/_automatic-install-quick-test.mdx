...
`% ~/Library/xPacks/@xpack-dev-tools/${props.shortName}/7.0.3-1.1/.content/bin/${props.programName} --version
...
<CodeBlock language="console"> {
`$ ~/.local/xPacks/@xpack-dev-tools/${props.shortName}/7.0.3-1.1/.content/bin/${props.programName} --version
${props.branding}7.0.3
`} </CodeBlock>
