...
<CodeBlock language="sh"> {
`xpm install @xpack-dev-tools/texinfo@${customField('releaseVersion')} --verbose
`} </CodeBlock>
...
<ul>
<li><code>xpack-texinfo-{customField('xpackVersion')}-darwin-x64.tar.gz</code></li>
<li><code>xpack-texinfo-{customField('xpackVersion')}-darwin-arm64.tar.gz</code></li>
</ul>
...
<ul>
<li><code>xpack-texinfo-{customField('xpackVersion')}-linux-x64.tar.gz</code></li>
<li><code>xpack-texinfo-{customField('xpackVersion')}-linux-arm64.tar.gz</code></li>
<li><code>xpack-texinfo-{customField('xpackVersion')}-linux-arm.tar.gz</code></li>
</ul>
