...
# How to install the xPack GNU texinfo
...
[![GitHub Release Date](https://img.shields.io/github/release-date/xpack-dev-tools/texinfo-xpack)](https://github.com/xpack-dev-tools/texinfo-xpack/releases)
[![npm (scoped)](https://img.shields.io/npm/v/%40xpack-dev-tools%2Ftexinfo?label=xpm&color=blue)](https://www.npmjs.com/package/@xpack-dev-tools/texinfo/)
![GitHub Downloads (all assets, all releases)](https://img.shields.io/github/downloads/xpack-dev-tools/texinfo-xpack/total)
[![npm](https://img.shields.io/npm/dm/%40xpack-dev-tools%2Ftexinfo?label=xpm%20downloads)](https://www.npmjs.com/package/@xpack-dev-tools/texinfo/)
...
The easiest (and recommended) way to install xPack GNU texinfo
...
The command to install the **latest** available version of **texinfo** is:
...
<CodeBlock language="sh"> {
`xpm install @xpack-dev-tools/texinfo@7.0.3-1.1 --verbose
`} </CodeBlock>
...
* add <code>@xpack-dev-tools/texinfo</code> to
  `package.json` as a
  development dependency; this associates a specific version of xPack GNU texinfo with
...
it is also possible to install xPack GNU texinfo only globally in
...
In order to access the xPack GNU texinfo binaries installed in
...
<CodeBlock language="sh"> {
`export PATH=$HOME/Library/xPacks/\@pack-dev-tools/texinfo/7.0.3-1.1/.content/bin:$PATH
`} </CodeBlock>
...
<CodeBlock language="sh"> {
`export PATH=$HOME/.local/xPacks/@xpack-dev-tools/texinfo/7.0.3-1.1/.content/bin:$PATH
`} </CodeBlock>
...
<ul>
<li><code>xpack-texinfo-7.0.3-1-darwin-x64.tar.gz</code></li>
<li><code>xpack-texinfo-7.0.3-1-darwin-arm64.tar.gz</code></li>
</ul>
...
example <code>/Users/ilg/Library/xPacks/texinfo/xpack-texinfo-7.0.3-1</code>:

<CodeBlock language="console"> {
`mkdir -p ~/Library/xPacks/texinfo
cd ~/Library/xPacks/texinfo

tar xvf ~/Downloads/xpack-texinfo-7.0.3-1-darwin-x64.tar.gz
chmod -R -w xpack-texinfo-7.0.3-1
`} </CodeBlock>
...
<ul>
<li><code>xpack-texinfo-7.0.3-1-linux-x64.tar.gz</code></li>
<li><code>xpack-texinfo-7.0.3-1-linux-arm64.tar.gz</code></li>
<li><code>xpack-texinfo-7.0.3-1-linux-arm.tar.gz</code></li>
</ul>
...
example <code>/home/ilg/.local/xPacks/texinfo/xpack-texinfo-7.0.3-1</code>:

<CodeBlock language="console"> {
`mkdir -p ~/.local/xPacks/texinfo
cd ~/.local/xPacks/texinfo

tar xvf ~/Downloads/xpack-texinfo-7.0.3-1-linux-x64.tar.gz
chmod -R -w xpack-texinfo-7.0.3-1
`} </CodeBlock>
