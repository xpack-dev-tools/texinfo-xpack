...
[![NPM Version](https://img.shields.io/npm/v/@xpack-dev-tools/texinfo?color=green)](https://www.npmjs.com/package/@xpack-dev-tools/texinfo/)
...
[project web site](https://xpack-dev-tools.github.io/texinfo-xpack/).

## Project source

The source code of the current release is available on
[GitHub tag v7.0.3-1.1 tree](https://github.com/xpack-dev-tools/texinfo-xpack/tree/v7.0.3-1.1).
